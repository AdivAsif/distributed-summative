...
#     {&PaxosTest.run_simple_2/3, TestUtil.get_dist_config(host, 3), 10, "No failures, 2 concurrent ballots, 3 nodes"},
    ...
    {&PaxosTest.run_simple_3/3, TestUtil.get_local_config(3), 1, "No failures, 2 concurrent instances, 3 local procs"},

#     {&PaxosTest.run_simple_many_1/3, TestUtil.get_dist_config(host, 5), 10, "No failures, many concurrent ballots 1, 5 nodes"},
    {&PaxosTest.run_simple_many_1/3, TestUtil.get_local_config(5), 1, "No failures, many concurrent ballots 1, 5 local procs"},
